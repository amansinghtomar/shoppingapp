...
export const ProductHeader = ({ productName, review, star }) => (
   <>
      ...
      <RatingContainer>
         ...
         <Rating name="half-rating-read" precision={star} defaultValue={star} readOnly />
      </RatingContainer>
   </>
);
...
export const ProductActions = ({ productPrice, TotalMRP, productDiscount,handleAddToCart,updateTextAddToBag,handleGoToCart}) => (
   <>
      <PriceContainer>
         ...
         <Typography as="h3" color="primary">{`${productDiscount}% OFF`}</Typography>
      </PriceContainer>
...
export const ProductInfo = ({ DeliveryDate, SellerName, productDetail, review }) => (
   <>
      <DeliveryContainer>
